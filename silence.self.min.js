!function (t) {
    ...
    var i = function () {
        ...
        t && t.length && (t.reverse().forEach(t => {
            if (t.target = t.target || "_self", t.children && t.children.length) {
                var a = t.children.map(t => (t.target = t.target || "_self", `<li><a class="menu" target="${t.target}" href="${t.url}">${t.title}</a></li>`));
        ...
        }), $("#header").prepend('<div class="esa-mobile-menu material-symbols-outlined">menu</div>'), $(".esa-mobile-menu").on("click", () => {
    ...
    var c = function () {
        ...
        if (t.enable) {
            ...
            let o = $("#cnblogs_post_body").find(e.join(",")), i = $(".esa-toolbar");
            if (!o.length) return i.find(".contents").remove(), !1;
            $("body").append('<div class="esa-contents noactive"></div>'), t.active && i.find(".contents").trigger("click");
            let l = 0, r = 0, c = 0, d = "<ul>";
            $.each(o, (e, o) => {
                const i = o.tagName.toLowerCase(), h = $(o).text();
                let u = $(o).attr("id"), p = "", f = h;
                if (t.index) i === a ? (l++, r = 0, c = 0, p = `<span class="level1">${l}. </span>`) : i === n ? (r++, c = 0, p = `<span class="level2">${l}.${r}. </span>`) : i === s && (c++, p = `<span class="level3">${l}.${r}.${c}. </span>`); else switch (i) {
                    case a:
                ...
                u || (u = $(o).text().replace(/\ /g, "-").toLowerCase(), $(o).attr("id", u)), d += `<li class="${i}" title="${h}">\n                    <a class="esa-anchor-link" href="#${u}">${p + f}</a>\n                 </li>`, $(o).append(`<a href="#${u}" class="esa-anchor">#</a>`).hover(() => {
    ...
    var p = function () {
        const t = n.signature;
        if (t.enable) {
            const e = $("#cb_post_title_url").attr("href"), a = t.author || currentBlogApp,
    ...
    var f = function () {
        const t = n.sponsor;
        if (!t.enable || t.enable && !t.paypal && !t.alipay && !t.wechat) return !1;
    ...
    var m = function () {
        ...
        const e = "silence-mode-" + currentBlogApp, a = "silence-theme-" + currentBlogApp, o = (new Date).getHours(),
        ...
        const r = $(".esa-toolbar"), c = $(".skin-popup");
        ...
        r.find(".bars").click((function () {
            ...
            let t = $("html").attr("mode"), a = "light" == t ? "dark" : "light";
    ...
    new class {
        ...
        building() {
            i(), l(), o(), r(), m(), s() ? (c(), u(), p(), f(), v()) : ($(".forFlow").css({marginLeft: "260px"}), $("#sideBar").show()), b.hide()
        }
    }
}]);